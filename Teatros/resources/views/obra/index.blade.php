...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <br>
            <p align="right">
                <a href="{{ route('obra.create') }}" class="btn btn-success">Crear Obra</a>
                <a href="{{ route('home') }}" class="btn btn-primary">
                    Regresar
                </a>
            </p>
            <table id="obra" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>Acciones</th>
                        <th>Id Obra</th>
